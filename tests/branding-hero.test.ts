...
test("footer presents a compact transparent logo on a warm neutral panel",()=>{assert.match(footer,/bg-brand-cream p-3/);assert.match(footer,/w-\[180px\]/);assert.match(footer,/sm:w-\[210px\]/);assert.match(footer,/object-contain/);assert.match(footer,/Elegance Woven With Faith/)});
