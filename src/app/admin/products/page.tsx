...
export default async function ProductsPage({searchParams}:{searchParams:Promise<Record<string,string|string[]|undefined>>}) {
 ...
 const page=Math.max(1,Number(value("page"))||1),pageSize=25,search=value("q").replace(/[%(),]/g,""),category=value("category"),type=value("type"),status=value("status"),stock=value("stock");
